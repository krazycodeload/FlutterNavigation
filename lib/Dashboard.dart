...
import 'package:flutternavigation/components/tv_show.dart';

import 'components/home.dart';
import 'components/setting.dart';
import 'components/watchList.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      drawer: NavigationDrawer(
        ...
        children: const [DrawerHeader(child: CircleAvatar(backgroundColor: Colors.transparent,backgroundImage: NetworkImage('https://i.pinimg.com/474x/0c/eb/c3/0cebc3e2a01fe5abcff9f68e9d2a06e4.jpg'),)),
          ListTile(
            dense: true,
            title: Text(
              "Switch Screen",
